...
<head>
    ...
    <title>@yield('title', 'Siswa') - Absensi Sekolah</title>
    ...
    <!-- Google Maps -->
    <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyA6bBHICpYyj3SXVm1L8UJlBj5KR3vPm2U"></script>
    ...
    <div class="container-siswa">
        ...
        <div class="sidebar">
            ...
            <div class="sidebar-menu">
                ...
                <a href="{{ route('siswa.absen') }}" class="sidebar-item {{ request()->routeIs('siswa.absen') ? 'active' : '' }}">
